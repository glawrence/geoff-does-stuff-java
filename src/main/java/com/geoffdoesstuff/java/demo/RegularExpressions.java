...
public class RegularExpressions {
    ...
    public static void main(String[] args) {
        ...
        exampleTextList.forEach(exampleText -> processRexExMatching(exampleText, REGULAR_EXPRESSION_3));

        DemoUtilities.outputTitle("Regular Expression - " + REGULAR_EXPRESSION_4, true);
        exampleTextList.forEach(exampleText -> processRexExMatching(exampleText, REGULAR_EXPRESSION_4));
    }
